...
\section*{Summary}
Experienced Engineering Manager with over 20 years of experience in web development, including over 10 years experience in technical leadership and project management for well-known Australian brands. Proven track record of delivering high-quality projects on time and within budget. Skilled in JavaScript, Node.js, cloud infrastructure and architecture. Adept at improving development processes, enhancing team performance, and driving product advancements. Recognized for technical expertise, winning internal awards for leadership and technical direction. Experienced in working with high-profile clients and leading cross-functional teams in dynamic environments. Passionate about mentoring and recruitment, with a focus on fostering a high-performance team culture. Committed to being a servant leader, empowering developers to reach their full potential and achieve collective success.

\section*{Skills}
\begin{itemize}
    \item Programming Languages: JavaScript, TypeScript, CSS
    \item Frameworks: Node.js, Angular, React, Express
    \item Tools: Git, AWS, Atlassian Suite
...
\begin{itemize}
    \item Managed 1-2 teams of developers with a total direct reports 6-12.
    \item Led the migration of ubank customers to the 86400 infrastructure, managing the transfer of over \$12 billion in customer funds for half a million customers.
...
\begin{itemize}
    \item Managed a team of 6-12 developers working on the Fox Sports website (pre-covid).
...
My duties also include maintenance and development of an existing LMS project for a large multinational client, as well as taking part in conference calls and meetings with our overseas and local clients. The LMS is available 
worldwide and handles training and certification in multiple languages. It handles thousands of students worldwide, and last year we issued 150,000 certifications. The certifications are integrated with salesforce, and are used in discount schemes worth millions of dollars annually.
