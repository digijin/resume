...
\begin{itemize}
    ...
    \item Frameworks: Node.js, Angular, React, Express, NestJS, Zend, Sitecore
...
\begin{itemize}
    ...
    \item Rebuilt the Fox Sports article page, resulting in a significant traffic increase (200\%+) driven by search engine optimization improvements.
\end{itemize}
